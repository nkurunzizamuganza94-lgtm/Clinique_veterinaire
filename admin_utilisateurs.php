...
<head>
    ...
    <title>Utilisateurs - Clinique Vétérinaire</title>
    ...
    <div class="row">
        <nav class="col-md-3 col-lg-2 sidebar p-0">
            ...
            <div class="py-3">
                ...
                <a href="admin_utilisateurs.php" class="active"><i class="fa-solid fa-users me-2"></i> Utilisateurs</a>
                <hr class="text-light">
                        ...
                        <tbody>
                            <?php foreach ($users as $u): ?>
                                <tr>
                                    ...
                                    <td class="fw-bold"><?= htmlspecialchars($u['nom']) ?></td>
